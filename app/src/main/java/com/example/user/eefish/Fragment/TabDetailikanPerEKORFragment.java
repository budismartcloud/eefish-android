...
public class TabDetailikanPerEKORFragment extends Fragment {
    String URL_GET_FISH_BY_ID, iduser,fishItemId,year,orderkind;
    int idikan;
    TextView hargaikan;
    Intent afterlogin;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_tab_perekor, container, false);
        final Calendar calendar = Calendar.getInstance();
        sessionManager = new SessionManager(getContext());
        idikan = getActivity().getIntent().getExtras().getInt("id");
        hargaikan = (TextView) rootView.findViewById(R.id.tvHargaIkanTerpilih_perekor);
        addcartButton = (Button) rootView.findViewById(R.id.but_detail_addcart_perekor);
        ...
        addcartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                iduser = String.valueOf(sessionManager.getIdUser()).trim();
                year = String.valueOf(calendar.get(Calendar.YEAR)).trim();
                orderkind = "2";
                fishItemId = String.valueOf(idikan).trim();
                addcart(iduser,year,fishItemId,orderkind);
            }
        });
...
//                                Toast.makeText(getActivity(), obj.getString("message"), Toast.LENGTH_SHORT).show();
                                ...
                                hargaikan.setText("Rp."+fish.getSingular_price()+",00");
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
